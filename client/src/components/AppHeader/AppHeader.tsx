...
export const AppHeaderComp: React.FunctionComponent<TAppHeaderProps> = ({accountBalance}) => {
    ...
    return (
        <div className="app__header">
            ...
            <div className="app__header-right">
                <Typography variant="h5" className="app__header-right-item">Account Balance: {accountBalance} {CURRENCY}</Typography>
                <Button variant="contained" onClick={openAskForLoanModal} className="app__header-right-item">Get Loan</Button>
                <Button variant="contained" color="secondary" onClick={openDepositFundsModal} className="app__header-right-item">Deposit Funds</Button>
            </div>
            <DepositFundsModal isOpen={isDepositFundsModalOpen} onClose={closeDepositFundsModal} />
            <AskLoanModal isOpen={isAskForLoanModalOpen} onClose={closeAskForLoanModal}/>
        </div>
    )
}
